...
Content flow is closely related to the writing system being used. Most of us are familiar with the horizontal, top-to-bottom orientation used in English and Ukrainian. But writing systems can be right-to-left for Arabic or Hebrew, and vertical, right-to-left for Chinese or Japanese. Traditional Mongolian script is vertical, left-to-right.
